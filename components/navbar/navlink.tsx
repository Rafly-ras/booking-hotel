  ...
  return (
    <>
       ...
       <div className={clsx("w-full md:block md:w-auto", {
        ...
        bg-gray-50 md:flex-row md:items-center md:space-x-10 md:p-0 md:mt-0 md:bprder-0
        md:bg-white">
            <li>
            ...
            <li className="pt-2 md:pt-0">
                <Link href="/signin" className="py=2.5 px-6 bg-orange-400 text-white hover:bg-orange-500
