...
const Footer = () => {
  return (
    <footer className="bg-gray-900">
            ...
            <div className="grid md:grid-cols-3 gap-7">
                <div>
                    ...
                    <p className="text-gray-400">
                        ...
                        recusandae impedit a odit corrupti.
                    </p>
                </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8
        text-center text-base text-gray-500">
            &copy; Copyright 2025 | PliyDev Fullstack | All Right Reserved
        </div>
    </footer>
  )
}
